...
def run() -> ProgramResult:
    ...
    step1 = df[df["age"] > 28]
    step2 = step1.assign(salary_k=lambda x: x["salary"] / 1000)
    step3 = step2.sort_values("salary_k", ascending=False)
    result = step3[["name", "dept", "salary_k"]]
